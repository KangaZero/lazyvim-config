...
---@field treesitter config.util.treesitter
---@field lsp config.util.lsp
---@field root config.util.root
---@field terminal config.util.terminal
---@field format config.util.format
---@field plugin config.util.plugin
---@field extras config.util.extras
---@field inject config.util.inject
---@field news config.util.news
---@field json config.util.json
---@field lualine config.util.lualine
---@field mini config.util.mini
---@field pick config.util.pick
---@field cmp config.util.cmp
---@field deprecated config.util.deprecated
local M = {}
M.deprecated = require("config.util.deprecated")
