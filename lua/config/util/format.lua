...
function M.health()
  ...
  local has_extra = vim.tbl_contains(Config.spec.modules, "config.plugins.extras.lsp.none-ls")
  if has_plugin and not has_extra then
    LazyVim.warn({
      ...
      "but you need to enable the `config.plugins.extras.lsp.none-ls` extra,",
