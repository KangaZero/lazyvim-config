---@class config.util.pick
---@overload fun(command:string, opts?:config.util.pick.Opts): fun()
...
---@class config.util.pick.Opts: table<string, any>
---@field root? boolean
---@field cwd? string
---@field buf? number
...
---@class LazyPicker
---@field name string
---@field open fun(command:string, opts?:config.util.pick.Opts)
...
---@param opts? config.util.pick.Opts
